...
public class SocialAccountControllerTest {
	...
	public void testGetAccountsById() throws Exception {
		...
		User newUser = new User(1, "group2", "password", "Cognixia", User.Role.ROLE_USER, "bio example", null);
		SocialAccount account = new SocialAccount(id, "group2_facebook", "Facebook description",
				SocialAccount.Platform.FACEBOOK, newUser);
	...
	public void testCreateAccount() throws Exception {
		...
		User newUser = new User(1, "group2", "password", "Cognixia", User.Role.ROLE_USER, "bio example", null);
		SocialAccount account = new SocialAccount(1, "group2_facebook", "Facebook description",
				SocialAccount.Platform.FACEBOOK, newUser);
	...
	public void testUpdateAccountNotFound() throws Exception {
		...
		when(service.updateAccount(Mockito.any(SocialAccount.class)))
